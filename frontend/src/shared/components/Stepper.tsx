...
export default function Stepper({
  ...
  return (
    ...
    >
      <div
        className={`mx-auto w-full max-w-3xl rounded-3xl shadow-xl ${stepCircleContainerClassName}`}
      ...
      >
        ...
        <StepContentWrapper
          ...
          currentStep={currentStep}
          direction={direction}
          className={`space-y-6 px-10 ${contentClassName}`}
        >
        ...
        {!isCompleted && (
          <div className={`px-8 pb-8 ${footerClassName}`}>
            ...
            >
              ...
              >
                {isLastStep
                  ? (nextButtonProps?.children ?? 'Complete')
                  : nextButtonText}
              </button>
            </div>
          </div>
...
function StepConnector({ isComplete }: StepConnectorProps) {
  const lineVariants: Variants = {
    ...
    complete: { width: '100%', backgroundColor: '#7a1c1c' },
  };
